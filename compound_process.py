...
if __name__ == '__main__':
    dataset = 'Davis'
    fold = 1
    file_path = 'data/' + dataset + '/DTA/warm_cold/compound_protein_fold/'
    file_path_id = 'data/' + dataset + '/' + dataset + '_compoundID_unique.csv'
    file_path_compound = 'data/' + dataset + '/' + dataset + '_compound_mapping.csv'
    dir_output = ('data/' + dataset + '/processed/DTA/warm_cold/compound_protein_cold/')
